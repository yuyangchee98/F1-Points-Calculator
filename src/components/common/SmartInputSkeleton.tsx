...
/**
 * Skeleton for Smart Input section
 * Reserves space to prevent layout shift while loading
 */
const SmartInputSkeleton: React.FC = () => {
  return (
    <div className="mb-6 p-4 bg-gray-50 rounded-lg shadow-sm border border-gray-200">
      ...
      {/* Content area skeleton - matches the "no access" state which is tallest */}
