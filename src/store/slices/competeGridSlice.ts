...
export const competeGridSlice = createSlice({
  name: 'competeGrid',
  initialState,
  reducers: {
...
export const {
  moveDriver: competeGridMoveDriver,
  placeDriver: competeGridPlaceDriver,
  resetGrid: competeGridResetGrid,
  clearPosition: competeGridClearPosition,
  fillRestOfSeason: competeGridFillRestOfSeason,
  clearEverything: competeGridClearEverything,
  setFastestLap: competeGridSetFastestLap
} = competeGridSlice.actions;

export default competeGridSlice.reducer;
